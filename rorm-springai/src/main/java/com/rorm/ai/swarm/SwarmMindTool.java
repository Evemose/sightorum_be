...
public class SwarmMindTool {
    ...
    public static SwarmMindTool forStep(ResearchPlanDTO plan, StepRef stepRef, SwarmMind swarmMind) {
        return new StepSwarmMindTool(swarmMind, plan, stepRef);
    }
    ...
    private static class StepSwarmMindTool extends SwarmMindTool {

        private final SwarmMind swarmMind;
        private final ResearchPlanDTO plan;
        private final StepRef stepRef;

        public StepSwarmMindTool(SwarmMind swarmMind, ResearchPlanDTO plan, StepRef stepRef) {
            super(swarmMind);
